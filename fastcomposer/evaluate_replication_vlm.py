...
SYSTEM_PROMPT = (
    ...
    "2. The person appears to be the same, but the image looks pasted or unnatural (identical facial expression, highly similar orientation, gestures are exactly the same, etc.)\n"
...
def generate_response_with_images(cfg: DictConfig) -> None:
    ...
    for idx, generated_image_path in enumerate(generated_image_paths):
        ...
        output_dict[generated_image_path] = json_data
